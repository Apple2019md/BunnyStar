...
function preload()
{
  ...
  mtstar = loadAnimation("empty.png");
...
function setup() 
{
  ...
  starDisplay.addAnimation("empty", mtstar);
  starDisplay.addAnimation("one", onestar);
  starDisplay.addAnimation("full", fullstar);
  starDisplay.changeAnimation("empty", mtstar);
...
function draw() 
{
  ...
  if(collide(fruit,star2, 30)==true)
  {
    console.log("star2")
    star2.visible = false;
    starDisplay.changeAnimation("full", fullstar);
  }
